...
void test1_space_set_north() {
    Space *s = NULL;
    s = space_create(5);
    PRINT_TEST_RESULT(space_set_north(s, 4001) == OK);
    space_destroy(s);
}

void test2_space_set_north() {
    Space *s = NULL;
    PRINT_TEST_RESULT(space_set_north(s, 4001) == ERROR);
}

void test1_space_set_south() {
    Space *s = NULL;
    s = space_create(5);
    PRINT_TEST_RESULT(space_set_south(s, 4001) == OK);
    space_destroy(s);
}

void test2_space_set_south() {
    Space *s = NULL;
    PRINT_TEST_RESULT(space_set_south(s, 4001) == ERROR);
}

void test1_space_set_east() {
    Space *s = NULL;
    s = space_create(5);
    PRINT_TEST_RESULT(space_set_east(s, 4001) == OK);
    space_destroy(s);
}

void test2_space_set_east() {
    Space *s = NULL;
    PRINT_TEST_RESULT(space_set_east(s, 4001) == ERROR);
}

void test1_space_set_west() {
    Space *s = NULL;
    s = space_create(5);
    PRINT_TEST_RESULT(space_set_west(s, 4001) == OK);
    space_destroy(s);
}

void test2_space_set_west() {
    Space *s = NULL;
    PRINT_TEST_RESULT(space_set_west(s, 4001) == ERROR);
}
...
void test1_space_get_north() {
    Space *s = NULL;
    s = space_create(5);
    space_set_north(s, 4001);
    PRINT_TEST_RESULT(space_get_north(s) == 4001);
    space_destroy(s);
}
...
void test1_space_get_south() {
    Space *s = NULL;
    s = space_create(5);
    space_set_south(s, 4002);
    PRINT_TEST_RESULT(space_get_south(s) == 4002);
    space_destroy(s);
}
...
void test1_space_get_east() {
    Space *s = NULL;
    s = space_create(5);
    space_set_east(s, 4003);
    PRINT_TEST_RESULT(space_get_east(s) == 4003);
    space_destroy(s);
}
...
void test1_space_get_west() {
    Space *s = NULL;
    s = space_create(5);
    space_set_west(s, 4004);
    PRINT_TEST_RESULT(space_get_west(s) == 4004);
    space_destroy(s);
}
...
void test1_space_get_object_id() {
    ...
    space_add_object(s, 2001);
    PRINT_TEST_RESULT(space_get_object_id(s, 0) == 2001);
    space_destroy(s);
}
...
void test1_space_check_object() {
    ...
    PRINT_TEST_RESULT(space_check_object(s, 2001) == TRUE);
    space_destroy(s);
}
...
void test2_space_check_object() {
    ...
    PRINT_TEST_RESULT(space_check_object(s, 2001) == FALSE);
    space_destroy(s);
}
